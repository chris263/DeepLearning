...
_SYNONYMS = {
    ...
    # --- NEW: RSI synonyms ---
    "rsi":     ["rsi14", "RSI", "RSI_14", "rsi_14"],
    "rsi14":   ["rsi", "RSI", "RSI_14", "rsi_14"],
    "RSI":     ["rsi", "rsi14", "RSI_14", "rsi_14"],
    "RSI_14":  ["rsi", "rsi14", "RSI", "rsi_14"],
}
            ...
            if side == "buy":
                ...
                if tp_pct is not None and tp_pct > 0:
                    ...
                    if oid:
                        ...
                        print(f"[WARN] TP order attached!!")
                ...
                if sl_pct is not None and sl_pct > 0:
                    ...
                    if oid:
                        ...
                        print(f"[WARN] SL order attached!")
